...
gui::Button::Button(float x, float y, float width, float height, unsigned short id) {
...
gui::ButtonColor::ButtonColor(float x, float y, float width, float height,
	...
	unsigned short id
) : gui::Button(x, y, width, height, id)
{
	this->shape.setSize(sf::Vector2f(this->buttonWidth, this->buttonHeight));
	this->shape.setPosition(sf::Vector2f(this->buttonPositionX, this->buttonPositionY));
	...
	this->text.setPosition(
		this->buttonPositionX + (this->buttonWidth / 2.f) - this->text.getGlobalBounds().width / 2.f,
...
gui::ButtonImage::ButtonImage(float x, float y, float width, float height,
	sf::Texture* texture,
	unsigned short id
) : gui::Button(x, y, width, height, id)
{
	this->texture = texture;
	this->sprite.setPosition(this->buttonPositionX, this->buttonPositionY);
...
void gui::ButtonImage::update(const sf::Vector2i& mousePosWindow)
{
	/* Update the booleans for hoverand pressed */
	this->buttonState = BTN_IDLE;
	// Hover
...
void gui::ButtonImage::render(sf::RenderTarget& target)
{
